...
public class HistoryVO {
	...
	public String getSpdSubCategory() {
		return spdSubCategory;
	}
	public void setSpdSubCategory(String spdSubCategory) {
		this.spdSubCategory = spdSubCategory;
	}
