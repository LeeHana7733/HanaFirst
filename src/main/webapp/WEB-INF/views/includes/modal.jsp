	...
	<div class="modal-dialog sm">
		<div class="modal-content">
		    ...
		    <div class="modal-body">
		    	<input type="hidden" name="spdCategoryP" class="form-control">
	      		<input type="hidden" name="spdSubCategoryP" class="form-control">
	      		<input type="hidden" name="spdPaymentP" class="form-control">
		    	...
		    	<div class="row bottom">
		    		...
		    		<div class="col-sm-8">
		    			<select name="spdCategory"  class="form-control"></select>
		    			<select name="spdSubCategory" class="form-control"><option value="">없음</select>
		    		</div>
		    	</div>
		    	<div class="row bottom">
